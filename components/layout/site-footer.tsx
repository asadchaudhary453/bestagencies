        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-6">
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="mt-5 flex items-center gap-3">
              <a
                href="https://web.facebook.com/bestagencies.co.uk/"
                target="_blank"
              ...
              <a
                href="https://twitter.com/bestagenciesuk"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.instagram.com/bestagencies.co.uk/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.linkedin.com/in/bestagenciesuk/"
                target="_blank"
                rel="noopener noreferrer"
